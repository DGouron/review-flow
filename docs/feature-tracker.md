...
| Extract webhook processing usecase | [73-extract-webhook-processing-usecase](specs/73-extract-webhook-processing-usecase.md) — [plan (Stage 1)](plans/73-execute-review-usecase.plan.md) — [report (Stage 1)](reports/73-execute-review-usecase.report.md) | implementing | 2026-06-20 |
