...
## [3.53.0](https://github.com/DGouron/review-flow/compare/reviewflow-v3.52.0...reviewflow-v3.53.0) (2026-08-14)
...
* add webhook transport guard and reloadable token source (spec 201) ([ceeb9ef](https://github.com/DGouron/review-flow/commit/ceeb9ef6b9ee7ff7077f19de4f210d4811f6a987))
...
* bound LLM action surface by provenance and authenticated thread inventory (spec 198) ([ae4d3c8](https://github.com/DGouron/review-flow/commit/ae4d3c89f0a744fb56aaf3f580747e9661e87e5d))
...
* **dashboard:** collapsible team analysis accordion ([e5937b9](https://github.com/DGouron/review-flow/commit/e5937b9940bc2b7481995a94a156f2df0b8ae785))
...
* **dashboard:** developer sheet score trend chart filtered by developer ([63391a3](https://github.com/DGouron/review-flow/commit/63391a38737c696f8fc3e0ce55f320b1a19d4abe))
...
* **dashboard:** export team insights as PDF via print ([2559681](https://github.com/DGouron/review-flow/commit/2559681bf00110d9324e0e06ce773fef98f78c0a))
...
* **dashboard:** integrate AI insights into team tab and developer sheet ([7416b3d](https://github.com/DGouron/review-flow/commit/7416b3ddf298c595ede5077047fa4ceed53f472c))
...
* **dashboard:** redesign team panel, dev cards and developer sheet UX ([e2a1b3f](https://github.com/DGouron/review-flow/commit/e2a1b3fb955dd16f976502bc98b13b3b9918419c))
...
* **dashboard:** show commits and lines added/deleted in stats header ([cc98a42](https://github.com/DGouron/review-flow/commit/cc98a42de920fdbd4e973c2b8b56d2ec7000be8a))
...
* **dashboard:** team tab with RPG-styled developer cards and insights ([82b2c6c](https://github.com/DGouron/review-flow/commit/82b2c6cf144d232b07b5a50aee306a09ea397af1))
...
* deduplicate redelivered gitlab webhook events by event uuid (spec 200) ([5bf5e9a](https://github.com/DGouron/review-flow/commit/5bf5e9ae5c07a8aca431e1e387f7aaa4594168e4))
...
* gate auto-run on trusted reviewer membership (spec 197) ([9805f2e](https://github.com/DGouron/review-flow/commit/9805f2e88184c7ef99f027848f7cb79ab8e518c2))
...
* **insights:** AI insights endpoint with Claude CLI invocation ([2d2d94d](https://github.com/DGouron/review-flow/commit/2d2d94d052f8098b21573edc61b7bd73c96f0dd7))
* **insights:** developer and team insights engine with persistence ([e96d4b3](https://github.com/DGouron/review-flow/commit/e96d4b3ef1dc843c6df82f551136581f34f2f90d))
...
* **review:** implement spec-220 project-derived review audit scope ([#349](https://github.com/DGouron/review-flow/issues/349)) ([694224a](https://github.com/DGouron/review-flow/commit/694224a78386c557611bcea8ee604fa048c11098))
* **review:** implement spec-224 follow-up review labels ([#380](https://github.com/DGouron/review-flow/issues/380)) ([c13e58d](https://github.com/DGouron/review-flow/commit/c13e58d680c0f04a844573db865d4a90ce482683))
* **review:** signal review state with platform labels (spec-221, spec-222) ([#373](https://github.com/DGouron/review-flow/issues/373)) ([b510690](https://github.com/DGouron/review-flow/commit/b5106903899c41774ebc27e1e4b78514a58cd5fc))
...
* route auto-path public-output verbs through the scanned post sink (spec 199) ([5de09aa](https://github.com/DGouron/review-flow/commit/5de09aa5a5267c69efc2cfc02f3076791729c260))
* route public-output bodies through a scanned post sink decorator (spec 199) ([6996dd2](https://github.com/DGouron/review-flow/commit/6996dd2a8c5170384f958acbcc7a4a1293a9e7a2))
* scope cli executor to a dedicated least-privilege token (spec 196) ([dce9984](https://github.com/DGouron/review-flow/commit/dce9984ac279342c98142ac7c1f3121637a0acf5))
...
* **settings:** expose trigger mode as a dashboard-editable runtime setting ([4aa7ed4](https://github.com/DGouron/review-flow/commit/4aa7ed4a41f2ef8bacff15c36f5a312fcd5db9eb))
...
* **stats:** aggregate commit count over last 100 MR/PR ([afcd8fe](https://github.com/DGouron/review-flow/commit/afcd8fed43597b3cb0dc16c935e703d602533f6d))
...
* **worktree:** implement spec-218 sync trusted claude assets ([#344](https://github.com/DGouron/review-flow/issues/344)) ([4bd2567](https://github.com/DGouron/review-flow/commit/4bd2567b80443d0d048203b18f5a6f2e1f88fede))
...
* [#247](https://github.com/DGouron/review-flow/issues/247) setup wizard deadlock when initiating tab is lost ([cbf906e](https://github.com/DGouron/review-flow/commit/cbf906e763609884e2d099e80a81074f70490a80))
* [#247](https://github.com/DGouron/review-flow/issues/247) setup wizard deadlock when initiating tab is lost ([0353d32](https://github.com/DGouron/review-flow/commit/0353d3242dc5665b58397dd374c8b0dab3bfb3d0))
...
* address PR [#126](https://github.com/DGouron/review-flow/issues/126) review — architecture and code quality ([195e68b](https://github.com/DGouron/review-flow/commit/195e68bf400cae134775a39ec2df78458b3bfef1))
...
* **deps:** patch hono, ws, qs, vite advisories via resolutions ([ba90b90](https://github.com/DGouron/review-flow/commit/ba90b90604d3011729d716c1c4e870e9ffb84db0))
...
* **insights:** calibrate level spread, enrich descriptions, add metrics ([6d8d73b](https://github.com/DGouron/review-flow/commit/6d8d73ba02153daddd5f32e17c98bd28c64524a6))
* **insights:** dispatch --bg session in target project ([a24f7c3](https://github.com/DGouron/review-flow/commit/a24f7c3de5d38cdaf3079dfb4812efebf4eef7f4))
* **insights:** enforce strict JSON schema in AI prompt with per-developer template ([a2ee6c8](https://github.com/DGouron/review-flow/commit/a2ee6c804dd3644d5ae3155cb03d0a1cfa421483))
* **insights:** ignore thinking-only turns when reading --bg transcript ([6c4b747](https://github.com/DGouron/review-flow/commit/6c4b7476c787fc8aa1e06a8ea2499c6b08fce594))
* **insights:** launch Claude CLI from /tmp with user-only settings to avoid CLAUDE.md injection ([6f305e9](https://github.com/DGouron/review-flow/commit/6f305e90e92c98e42f64adae6fb4db9c313aa682))
* **insights:** parse Claude response without generatedAt field ([dee856a](https://github.com/DGouron/review-flow/commit/dee856a2ec6a39b1d6bb00507ba1ba2061731b16))
* **insights:** pass language from dashboard, show AI team panel instead of empty rule-based ([961f904](https://github.com/DGouron/review-flow/commit/961f9043450c3353dda012222965e03be57b350e))
...
* **insights:** reduce prompt size, increase timeout to 300s, prevent refresh during generation ([d214dcc](https://github.com/DGouron/review-flow/commit/d214dcc0caef98e61949da38d1740d82ca2787c1))
* **integration:** reconcile SPEC-196 auto-path unwire with SPEC-198/199 constrained dispatch ([cf0a869](https://github.com/DGouron/review-flow/commit/cf0a8699d36acd74736809de57145d6126393ad5))
* **invoker:** override global plan mode to prevent review hang ([e26520d](https://github.com/DGouron/review-flow/commit/e26520d86e982efe6b6920c800175c97c708a94e))
* **invoker:** resolve MCP server path in tsx dev mode ([d70fb73](https://github.com/DGouron/review-flow/commit/d70fb731defeb3f6da35d876c89f37e17ccd9d71))
...
* translate French error message to English in generateAiInsights ([192796e](https://github.com/DGouron/review-flow/commit/192796e6ada873964d9a38b507da397995d9191f))
* trigger mode chip + macOS desktop notifications ([#368](https://github.com/DGouron/review-flow/issues/368)) ([e4b337c](https://github.com/DGouron/review-flow/commit/e4b337cf5921b76bbba9e401500ef72aa408e040))
...
* **webhook:** recover unposted reviews on reviewflow-app restart ([#206](https://github.com/DGouron/review-flow/issues/206)) ([5d430ec](https://github.com/DGouron/review-flow/commit/5d430ecd576777c225a0cdd9c709739b62b90269))
...
* **webhook:** extract executeReview usecase (spec-073 stage 1) ([d92ce1f](https://github.com/DGouron/review-flow/commit/d92ce1f9dbece3a84346755d94286d7d77d3df4d))
* **webhook:** extract handleClose usecase (spec-073 stage 2) ([82c1728](https://github.com/DGouron/review-flow/commit/82c1728745d4546d5b48310b413bde7b17bfb57e))
