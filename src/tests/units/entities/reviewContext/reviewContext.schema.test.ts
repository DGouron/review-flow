...
describe('reviewContextSchema', () => {
  ...
  it('should validate context with threads and actions', () => {
    const context = {
      ...validContext,
      threads: [{ id: 'thread-1', file: 'src/file.ts', line: 10, status: 'open', body: 'Issue' }],
      actions: [{ type: 'THREAD_RESOLVE', threadId: 'thread-1' }],
    };
...
describe('createReviewContextInputSchema', () => {
  ...
  it('should validate input with threads', () => {
    const input = {
      ...
      threads: [{ id: 'disc-123', file: 'src/main.ts', line: 5, status: 'open', body: 'Fix this' }],
    };
