...
export function getThreads(jobId: string, deps: GetThreadsDependencies): GetThreadsResult {
  ...
  const reviewContext = reviewContextGateway.read(jobContext.localPath, jobContext.mergeRequestId);
