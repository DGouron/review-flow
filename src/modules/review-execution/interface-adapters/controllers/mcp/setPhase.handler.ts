...
import { setPhase, type SetPhaseDependencies } from '../../../usecases/mcp/setPhase.usecase.js';
...
function isValidPhase(phase: unknown): phase is ReviewPhase {
  return typeof phase === 'string' && VALID_PHASES.some((validPhase) => validPhase === phase);
}
